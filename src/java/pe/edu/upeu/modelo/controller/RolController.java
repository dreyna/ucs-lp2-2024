...
public class RolController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(opcion){
            ...
            case 2 -> out.println(rolDao.createRol(new RolEntity(0,request.getParameter("rol"),1)));
            ...
            case 5 -> out.println(rolDao.updateRol(new RolEntity(Integer.parseInt(request.getParameter("id")),request.getParameter("rol"),1)));
        }
    }
